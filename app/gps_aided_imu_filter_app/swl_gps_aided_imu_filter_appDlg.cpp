...
BEGIN_MESSAGE_MAP(Cswl_gps_aided_imu_filter_appDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BUTTON_USE_SENSOR_INPUT, &Cswl_gps_aided_imu_filter_appDlg::OnBnClickedButtonUseSensorInput)
	ON_BN_CLICKED(IDC_BUTTON_USE_FILE_INPUT, &Cswl_gps_aided_imu_filter_appDlg::OnBnClickedButtonUseFileInput)
END_MESSAGE_MAP()
...
void Cswl_gps_aided_imu_filter_appDlg::OnBnClickedButtonUseSensorInput()
{
	CGpsAidedImuFilterDialog dlg;
	dlg.DoModal();
}

void Cswl_gps_aided_imu_filter_appDlg::OnBnClickedButtonUseFileInput()
{
	CFileBasedFilteringDialog dlg;
	dlg.DoModal();
}
