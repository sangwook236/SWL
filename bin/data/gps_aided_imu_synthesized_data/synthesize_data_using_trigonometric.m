...
save('synthesized_data_using_trigonometric.txt', 'traj_saved', '-ascii');

figure;
plot(time, traj_poses(:,1), 'r-', time, traj_poses(:,2), 'g-', time, traj_poses(:,3), 'b-');
figure;
plot(time, traj_vels(:,1), 'r-', time, traj_vels(:,2), 'g-', time, traj_vels(:,3), 'b-');
figure;
plot(time, traj_accels(:,1), 'r-', time, traj_accels(:,2), 'g-', time, traj_accels(:,3), 'b-');
