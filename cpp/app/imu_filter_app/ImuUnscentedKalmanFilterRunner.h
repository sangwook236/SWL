#if !defined(__SWL_IMU_FILTER_APP__IMU_UNSCENTED_KALMAN_FILTER_WITH_CALIBRATION__H_)
#define __SWL_IMU_FILTER_APP__IMU_UNSCENTED_KALMAN_FILTER_WITH_CALIBRATION__H_ 1
...
class ImuUnscentedKalmanFilterRunner
{
public:
	//typedef ImuUnscentedKalmanFilterRunner base_type;
...
public:
	ImuUnscentedKalmanFilterRunner(const double Ts, const size_t stateDim, const size_t inputDim, const size_t outputDim, AdisUsbz *adis);
	~ImuUnscentedKalmanFilterRunner();

private:
	ImuUnscentedKalmanFilterRunner(const ImuUnscentedKalmanFilterRunner &rhs);
...
#endif  // __SWL_IMU_FILTER_APP__IMU_UNSCENTED_KALMAN_FILTER_WITH_CALIBRATION__H_
