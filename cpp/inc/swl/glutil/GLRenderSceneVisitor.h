#if !defined(__SWL_GL_UTIL__GL_RENDER_SCENE_VISITOR__H_)
#define __SWL_GL_UTIL__GL_RENDER_SCENE_VISITOR__H_ 1
...
class SWL_GL_UTIL_API GLRenderSceneVisitor: public IGLSceneVisitor
{
public:
...
public:
	GLRenderSceneVisitor(const RenderMode renderMode, const bool isPickingState = false)
...
#endif  // __SWL_GL_UTIL__GL_RENDER_SCENE_VISITOR__H_
