...
public:
	...
	//	-. for a single independent observation sequence.
	bool trainByMAPUsingEntropicPrior(const size_t N, const uivector_type &observations, const double z, const double terminationTolerance, const size_t maxIteration, size_t &numIteration, double &initLogProbability, double &finalLogProbability);
	//	-. for multiple independent observation sequences.
	bool trainByMAPUsingEntropicPrior(const std::vector<size_t> &Ns, const std::vector<uivector_type> &observationSequences, const double z, const double terminationTolerance, const size_t maxIteration, size_t &numIteration, std::vector<double> &initLogProbabilities, std::vector<double> &finalLogProbabilities);
...
protected:
	...
	// MAP learning using entropic prior.
	//	-. for a single independent observation sequence.
	virtual void doEstimateObservationDensityParametersByMAPUsingEntropicPrior(const size_t N, const unsigned int state, const uivector_type &observations, const dmatrix_type &gamma, const double z, const double terminationTolerance, const size_t maxIteration, const double denominatorA) = 0;
	//	-. for multiple independent observation sequences.
