#if !defined(__SWL_BASE__POINT__H_)
#define __SWL_BASE__POINT__H_ 1
...
protected:
	bool isEqual(const Point2<T> &rPt, const T &Tol = T(1.0e-5)) const
...
protected:
	bool isEqual(const Point3<T> &rPt, const T &Tol = T(1.0e-5)) const
