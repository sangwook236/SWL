#if !defined(__SWL_KINEMATICS__PUMA_KINEMATICS__H_)
#define __SWL_KINEMATICS__PUMA_KINEMATICS__H_ 1
...
class SWL_KINEMATICS_API PumaKinematics: public ArticulatedKinematics
{
public:
...
private:
	PumaKinematics(const PumaKinematics &rhs);
	PumaKinematics & operator=(const PumaKinematics &rhs);
...
#endif  // __SWL_KINEMATICS__PUMA_KINEMATICS__H_
