...
public:
	...
	static unsigned int genOrder(bool isFixed, MathConstant::AXIS first, MathConstant::AXIS second, MathConstant::AXIS third);
	static bool isFixed(unsigned int order)  {  return !(order & 0xF000);  }
	static bool parseOrder(unsigned int order, MathConstant::AXIS& first, MathConstant::AXIS& second, MathConstant::AXIS& third);
};
...
{
public:
	RotationAngle(double alpha = 0.0, double beta = 0.0, double gamma = 0.0)
...
public:
	...
	static RotationAngle calc(unsigned int order, const RMatrix3<double>& mat);
...
public:
	...
	///
	bool isZero(double tol = MathConstant::EPS) const
	{  return MathUtil::isZero(alpha_, tol) && MathUtil::isZero(beta_, tol) && MathUtil::isZero(gamma_, tol);  }
	bool isEqual(const RotationAngle& rhs, double tol = MathConstant::EPS) const
	...
	/// scalar operation
	RotationAngle operator*(double S) const
	{  return RotationAngle(alpha_*S, beta_*S, gamma_*S);  }
	RotationAngle& operator*=(double S)
...
private:
	///
	bool isBounded(double angle) const
...
public:
	///
	static RMatrix3<double> rotateX(double radian);
	static RMatrix3<double> rotateY(double radian);
	static RMatrix3<double> rotateZ(double radian);
	static RMatrix3<double> rotate(double radian, const TVector3<double>& axis);

	/// calculate a rotation matrix
	static RMatrix3<double> rotate(unsigned int order, const RotationAngle& angle);
...
private:
	/// relative rotation:Euler angle
	static RMatrix3<double> rotateRelativeXYZ(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeXZY(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeYZX(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeYXZ(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeZXY(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeZYX(double alpha, double beta, double gamma);

	static RMatrix3<double> rotateRelativeXYX(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeXZX(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeYZY(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeYXY(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeZXZ(double alpha, double beta, double gamma);
	static RMatrix3<double> rotateRelativeZYZ(double alpha, double beta, double gamma);
};
