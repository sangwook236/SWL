#if !defined(__SMART_TV__GESTURE__GESTURE_CLASSIFIER_BY_TEMPORAL_HISTOGRAM__H_)
#define __SMART_TV__GESTURE__GESTURE_CLASSIFIER_BY_TEMPORAL_HISTOGRAM__H_ 1


#include "SmartGesture/Gesture/IGestureClassifier.h"
...
class GestureClassifierByTemporalHistogram: public IGestureClassifier
{
public:
	struct Params
	{
...
public:
	GestureClassifierByTemporalHistogram(const Params &params);
	explicit GestureClassifierByTemporalHistogram(const GestureClassifierByTemporalHistogram &rhs);
	~GestureClassifierByTemporalHistogram();

	GestureClassifierByTemporalHistogram & operator=(const GestureClassifierByTemporalHistogram &rhs);
...
#endif  // __SMART_TV__GESTURE__GESTURE_CLASSIFIER_BY_TEMPORAL_HISTOGRAM__H_
