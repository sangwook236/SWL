...
public:
	...
	typedef std::list<boost::scoped_ptr<roi_type> > rois_type;
...
public:
	...
	//
	void setValidRegion(const region_type &validRegion)  {  validRegion_ = validRegion;  }
