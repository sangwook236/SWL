...
class MyRunner(object):
	def __init__(self, is_dataset_generated_at_runtime, data_dir_path=None, train_test_ratio=0.8):
		...
		if is_dataset_generated_at_runtime:
			...
			start_time = time.time()
			self._dataset = text_line_data.RunTimeHangeulJamoAlphaMatteTextLineDataset(set(dictionary_words), image_height, image_width, image_channel, font_list, handwriting_dict, max_label_len=max_label_len)
