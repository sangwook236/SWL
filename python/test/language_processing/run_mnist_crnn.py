...
class SimpleCrnnTrainer(NeuralNetTrainer):
	def __init__(self, neuralNet, initial_epoch=0):
		...
		with tf.name_scope('learning_rate'):
			...
			learning_rate = tf.train.exponential_decay(start_learning_rate, global_step, decay_steps, decay_rate=0.96, staircase=True)
			#learning_rate = tf.train.inverse_time_decay(start_learning_rate, global_step, decay_steps, decay_rate=0.96, staircase=True)
			#learning_rate = tf.train.natural_exp_decay(start_learning_rate, global_step, decay_steps, decay_rate=0.96, staircase=True)
