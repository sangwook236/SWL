...
class MyFileBasedTextLineDataset(text_line_data.FileBasedTextLineDatasetBase):
	def __init__(self, label_converter, data_dir_path, image_height, image_width, image_channel, train_test_ratio, max_label_len, use_NWHC=True, warn_about_small_image=True):
		super().__init__(label_converter, image_height, image_width, image_channel, use_NWHC, warn_about_small_image)
	...
	def __init__(self, image_height, image_width, image_channel, max_label_len, train_test_ratio=0.8, is_dataset_generated_at_runtime=True, is_fine_tuned=False):
		...
		if is_dataset_generated_at_runtime:
			...
			if is_fine_tuned:
				...
				data_dir_path = data_base_dir_path + '/text/receipt'

				self._dataset = MyFileBasedTextLineDataset(self._label_converter, data_dir_path, image_height, image_width, image_channel, train_test_ratio, max_label_len, warn_about_small_image=False)
			else:
				# Data generation.
