...
class MyRunner(object):
	def __init__(self, is_sparse_output, num_epochs, batch_size):
		...
		self._dataGenerator = Synth90kDataGenerator(self._num_epochs, self._is_sparse_output, is_output_augmented, is_augmented_in_parallel, is_npy_files_used_as_input)
