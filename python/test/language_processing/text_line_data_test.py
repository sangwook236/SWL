...
def RunTimeCorruptedTextLinePairDataset_test():
	...
	if False:
		...
		start_time = time.time()
		image_height, image_width, image_channel = 64, 640, 1
		dataset = text_line_data.RunTimeCorruptedTextLinePairDataset(korean_word_set, image_height, image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating a Korean dataset: {} secs.'.format(time.time() - start_time))
	...
	if False:
		...
		start_time = time.time()
		image_height, image_width, image_channel = 32, 320, 1
		dataset = text_line_data.RunTimeCorruptedTextLinePairDataset(english_word_set, image_height, image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating an English dataset: {} secs.'.format(time.time() - start_time))
	...
	if True:
		...
		start_time = time.time()
		image_height, image_width, image_channel = 64, 640, 1
		dataset = text_line_data.RunTimeCorruptedTextLinePairDataset(all_word_set, image_height, image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating a Korean+English dataset: {} secs.'.format(time.time() - start_time))
...
def RunTimeSuperResolvedTextLinePairDataset_test():
	...
	if False:
		...
		dataset = text_line_data.RunTimeSuperResolvedTextLinePairDataset(korean_word_set, hr_image_height, hr_image_width, lr_image_height, lr_image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating a Korean dataset: {} secs.'.format(time.time() - start_time))
	...
	if False:
		...
		lr_image_height, lr_image_width, image_channel = 16, 160, 1
		hr_image_height, hr_image_width = lr_image_height * sr_ratio, lr_image_width * sr_ratio
		dataset = text_line_data.RunTimeSuperResolvedTextLinePairDataset(english_word_set, hr_image_height, hr_image_width, lr_image_height, lr_image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating an English dataset: {} secs.'.format(time.time() - start_time))
	...
	if True:
		...
		lr_image_height, lr_image_width, image_channel = 16, 160, 1
		hr_image_height, hr_image_width = lr_image_height * sr_ratio, lr_image_width * sr_ratio
		dataset = text_line_data.RunTimeSuperResolvedTextLinePairDataset(all_word_set, hr_image_height, hr_image_width, lr_image_height, lr_image_width, image_channel, font_list, handwriting_dict, corrupt_functor=corrupt)
		print('End creating a Korean+English dataset: {} secs.'.format(time.time() - start_time))
