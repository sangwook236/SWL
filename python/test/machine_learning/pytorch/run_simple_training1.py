...
import os, shutil, argparse, logging, time, datetime
import numpy as np
import torch
import torchvision
import cv2
...
def main():
	...
	if args.train:
		...
		history = runner.train(new_model_filepath, model_checkpoint_filepath, final_epoch, initial_epoch, is_training_resumed, device=train_device)
