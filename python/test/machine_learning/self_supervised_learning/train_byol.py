...
def main():
	...
	try:
		...
		ssl_model = model_byol.ByolModule(encoder, projector, predictor, ssl_augmenter, ssl_augmenter, moving_average_decay, is_momentum_encoder_used, is_model_initialized, is_all_model_params_optimized, logger)
