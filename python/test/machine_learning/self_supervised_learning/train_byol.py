...
def main():
	...
	try:
		...
		ssl_model = model_byol.ByolModule(encoder, projector, predictor, moving_average_decay, is_momentum_encoder_used, augmenter, augmenter, is_model_initialized, is_all_model_params_optimized, logger)
...
#	python train_byol.py --dataset cifar10 --epoch 20 --batch 32 --model_file ./byol_models/model.ckpt --out_dir ./byol_train_outputs
#	python train_byol.py --dataset mnist --epoch 10 --batch 64 --out_dir ./byol_train_outputs --log byol_log --log_dir ./log
