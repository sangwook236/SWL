...
def main():
	...
	projector_hidden_dim, projector_output_dim = 4096, 256
	predictor_hidden_dim, predictor_output_dim = 4096, 256
	...
	try:
		...
		model = model_relic.RelicModule(base_model, projector, predictor, moving_average_decay, use_momentum, augmenter, augmenter, is_model_initialized, is_all_model_params_optimized, logger)
...
# Usage:
#	python train_relic.py --epoch 20 --batch 64 --out_dir ./relic_train_outputs
#	python train_relic.py --epoch 10 --batch 32 --model_file ./relic_model/model.ckpt --out_dir ./relic_train_outputs
#	python train_relic.py --epoch 40 --batch 64 --out_dir ./relic_train_outputs --log relic_log --log_dir ./log
