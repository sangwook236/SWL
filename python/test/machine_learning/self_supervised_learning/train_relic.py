...
def main():
	...
	try:
		...
		ssl_model = model_relic.RelicModule(config_training, encoder, projector, predictor, ssl_augmenter, ssl_augmenter, is_model_initialized, logger)
...
# Usage:
#	python train_relic.py --help
#	python train_relic.py --config ./config/train_relic.yaml
#	python train_relic.py --config ./config/train_relic.yaml --model_file ./relic_models/model.ckpt
#	python train_relic.py --config ./config/train_relic.yaml --out_dir ./relic_train_outputs
#	python train_relic.py --config ./config/train_relic.yaml --log relic_log --log_dir ./log
