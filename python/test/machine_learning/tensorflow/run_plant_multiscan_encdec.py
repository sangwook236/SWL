...
def main():
	...
	if does_need_training:
		...
		with eval_session.as_default() as sess:
			with sess.graph.as_default():
				evaluate_neural_net_with_decoder_input(sess, nnEvaluator, val_encoder_input_seqs, val_decoder_input_seqs, val_decoder_output_seqs, batch_size, eval_saver, checkpoint_dir_path, is_time_major)
	...
	with infer_session.as_default() as sess:
		with sess.graph.as_default():
			...
			inferences = infer_by_neural_net(sess, nnInferrer, test_data, batch_size, infer_saver, checkpoint_dir_path)
