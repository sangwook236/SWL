#if !defined(__SWL_GESTURE_RECOGNITION__HISTOGRAM_ACCUMULATOR__H_)
#define __SWL_GESTURE_RECOGNITION__HISTOGRAM_ACCUMULATOR__H_ 1
...
#endif  // __SWL_GESTURE_RECOGNITION__HISTOGRAM_ACCUMULATOR__H_
