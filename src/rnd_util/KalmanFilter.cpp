...
KalmanFilter::KalmanFilter(const DiscreteLinearStochasticSystem &system, const gsl_vector *x0, const gsl_matrix *P0)
...
//-------------------------------------------------------------------------
// the continuous plant: Kalman-Bucy filter
//
...
//-------------------------------------------------------------------------
// the discrete plant: Discrete Kalman Filter
//
