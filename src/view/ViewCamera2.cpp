...
inline bool ViewCamera2::setView(int iX1, int iY1, int iX2, int iY2)
{
	...
	if (!VCtoNC(Point2<int>(rctView.left, rctView.bottom), ptNC1) || !VCtoNC(Point2<int>(rctView.right, rctView.top), ptNC2))
		return false;
...
inline bool ViewCamera2::VCtoNC(int iVCx, int iVCy, double& rNCx, double& rNCy) const
{
...
inline bool ViewCamera2::VCtoNC(const Point2<int>& rVC, Point2<double>& rNC) const
{
...
inline bool ViewCamera2::NCtoVC(double dNCx, double dNCy, int& rVCx, int& rVCy) const
{
...
inline bool ViewCamera2::NCtoVC(const Point2<double>& rNC, Point2<int>& rVC) const
{
