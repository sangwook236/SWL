...
/*static*/ const double ImuUnscentedKalmanFilterRunner::REF_GRAVITY_ = 9.780327 * (1.0 + 0.0053024 * sin_lambda*sin_lambda - 0.0000058 * sin_2lambda*sin_2lambda) - 3.086e-6 * h;  // [m/sec^2]
