#if !defined(__SWL_WIN_VIEW_TEST__VIEW_EVENT_HANDLER__H_)
#define __SWL_WIN_VIEW_TEST__VIEW_EVENT_HANDLER__H_ 1
...
#endif  // __SWL_WIN_VIEW_TEST__VIEW_EVENT_HANDLER__H_
