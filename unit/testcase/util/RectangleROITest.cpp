...
{
	const swl::RectangleROI::real_type eps = swl::RectangleROI::real_type(1.0e-15);
...
public:
	void testMoveVertex()
	{
		...
		{
			swl::RectangleROI roi(pt1, pt2, true, swl::RectangleROI::color_type(), swl::RectangleROI::real_type(1));
	...
	void testIsVertex()
	{
		...
		const swl::RectangleROI::point_type pt1(-20.0f, 10.0f), pt2(40.0f, 25.0f);
		const swl::RectangleROI roi(pt1, pt2, true, swl::RectangleROI::color_type(), swl::RectangleROI::real_type(1));
...
struct RectangleROI: public CppUnit::TestFixture
{
private:
	CPPUNIT_TEST_SUITE(RectangleROI);
...
//CPPUNIT_TEST_SUITE_REGISTRATION(swl::unit_test::RectangleROI);
CPPUNIT_REGISTRY_ADD_TO_DEFAULT("SWL.Util");
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(swl::unit_test::RectangleROI, "SWL.Util");
#endif
